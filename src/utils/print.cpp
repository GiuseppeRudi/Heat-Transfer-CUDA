...
void saveTemperature(std::string file_base_name, std::string file_extension, unsigned int step, double* gridTemperature, unsigned int nRows, unsigned int nCols, unsigned int fieldW)
{
